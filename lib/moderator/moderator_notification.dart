...
class _ModeratorNotificationsState extends State<ModeratorNotifications> {
  ...
  List<Map<String, dynamic>> allNotifications = [
    {
      ...
      'message': 'Customer John Doe has completed payment of RM 450.00 for Seaside Villa booking (Check-in: 12/15/2025).',
    ...
    },
    {
      ...
      'message': 'Customer Sarah Lee enquired about Mountain Retreat for dates 12/20/2025 - 12/25/2025. Property is fully booked.',
    ...
    },
    {
      ...
      'message': 'Admin Mike suggested alternative property for customer Alex Chen. Beach House (3BR, 2BA) available for 12/18/2025 - 12/22/2025.',
    ...
    },
    {
      ...
      'type': 'payment_received',
      'title': 'Payment Received',
      'message': 'Customer Emma Wilson has completed payment of RM 320.00 for Urban Loft booking.',
    ...
    },
    {
      ...
      'type': 'broadcast_suggestion',
      'title': 'Broadcast Suggestion',
      'message': 'Moderator Jane broadcast: Customer David needs 4BR property for family vacation. City Villa available.',
    ...
    },
    {
      ...
      'type': 'room_enquiry',
      'title': 'Room Enquiry - Fully Booked',
      'message': 'Customer Lisa Chen enquired about Luxury Suite. All rooms booked for requested period.',
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Suggestion picked up successfully!'),
  ...
  void _navigateToPage(int index) {
    ...
    if (index == 0) {
      Navigator.push(context, MaterialPageRoute(builder: (context) => ModeratorDashboard()));
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Navigate to Dashboard page'),
              ...
              if (unreadCount > 0)
                TextButton.icon(
                  ...
                  style: TextButton.styleFrom(
                    foregroundColor: const Color(0xFF78AAFF),
                  ),
                ),
            ],
          ),
  ...
  Widget _buildFilterChip(String value, String label) {
    ...
    return Padding(
      ...
      child: FilterChip(
        ...
        backgroundColor: Colors.white,
        selectedColor: const Color(0xFF78AAFF),
        labelStyle: TextStyle(
          color: isSelected ? Colors.white : const Color(0xFF64748B),
          fontWeight: isSelected ? FontWeight.w600 : FontWeight.normal,
        ),
        side: BorderSide(
          color: isSelected ? const Color(0xFF78AAFF) : const Color(0xFFE2E8F0),
        ),
      ),
    );
  }
    ...
    return Dismissible(
      ...
      child: InkWell(
        ...
        child: Container(
          margin: const EdgeInsets.only(bottom: 16),
          decoration: BoxDecoration(
            color: notification['isRead'] ? Colors.white : const Color(0xFFE7F0FF),
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
              color: notification['isRead'] ? const Color(0xFFE2E8F0) : const Color(0xFF78AAFF),
              ...
              child: Column(
                children: [
                  ...
                  if (notification['amount'] != null) ...[
                    const SizedBox(height: 12),
                    _buildDetailItem(Icons.attach_money, 'Amount', 'RM ${notification['amount'].toStringAsFixed(2)}'),
                  ],
                  ...
                  if (notification['broadcastBy'] != null) ...[
                    const SizedBox(height: 12),
                    _buildDetailItem(Icons.person_outline, 'Broadcast By', notification['broadcastBy']),
                  ],
  ...
  Widget _buildDetailItem(IconData icon, String label, String value) {
    return Row(
      children: [
        Icon(icon, size: 18, color: const Color(0xFF78AAFF)),
