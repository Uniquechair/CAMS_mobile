...
import 'owner_book_and_pay.dart';
...
class OwnerAuditTrails extends StatefulWidget {
  const OwnerAuditTrails({super.key});

  @override
  State<OwnerAuditTrails> createState() => _OwnerAuditTrailsState();
}

class _OwnerAuditTrailsState extends State<OwnerAuditTrails> {
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.history, size: 22, color: Color(0xFF4188FF)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
