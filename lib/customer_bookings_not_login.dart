...
import 'customer_cart_not_login.dart';

class CustomerBookingsNotLogin extends StatefulWidget {
  const CustomerBookingsNotLogin({super.key});

  @override
  State<CustomerBookingsNotLogin> createState() => _CustomerBookingsNotLoginState();
}
...
class _CustomerBookingsNotLoginState extends State<CustomerBookingsNotLogin> {
  ...
  void _navigateToPage(int index) {
    ...
    if (index == 0) {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => CustomerCartNotLogin()));
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Navigate to Cart page')),
      );
    }
  }
